...
export const TRANSLATIONS: Record<Language, TranslationDictionary> = {
  "pt-BR": {
    ...
    landing: {
      ...
      testim1: "Nunca matei uma planta desde que tenho o NeuFlorest. É quase mágico.",
    ...
    login: {
      ...
      sub: "Entre na sua conta NeuFlorest",
      email: "E-mail",
      password: "Senha",
  ...
  en: {
    ...
    landing: {
      ...
      testim1: "I haven't killed a single plant since I got NeuFlorest. It's almost magical.",
      testim1Author: "- Ana Paula, São Paulo",
    ...
    login: {
      title: "Welcome back",
      sub: "Sign in to your NeuFlorest account",
      email: "Email",
      password: "Password",
  ...
  es: {
    ...
    landing: {
      ...
      testim1: "No he matado ninguna planta desde que tengo NeuFlorest. Es casi mágico.",
      testim1Author: "- Ana Paula, São Paulo",
    ...
    login: {
      ...
      sub: "Entra en tu cuenta NeuFlorest",
      email: "Correo",
      password: "Contraseña",
